...
<html>
  ...
  <body>
    <form action="${pageContext.request.contextPath}/servlet/PostgraduateController?operation=update" method="post">
    	<table border="1" width="58%">
    		...
    		<tr>
    			<td>专业:</td>
    			<td>
    				<input type="text" name="major" value="${formBean.major }"/>${formBean.errors.major }
    			</td>
    		</tr>
    		<tr>
    			<td>导师编号:</td>
    			<td>
    				<input type="text" name="teacherNum" value="${formBean.teacherNum }"/>${formBean.errors.teacherNum }
    			</td>
    		</tr>
    		<tr>
